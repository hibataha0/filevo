...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(version) => "إصدار التطبيق ${version}";

  static String m2(title) => "تفاصيل التصنيف: ${title}";

  static String m3(fileName) => "هل أنت متأكد من حذف الملف \'${fileName}\'؟";

  static String m4(folderName) =>
      "هل أنت متأكد من حذف المجلد \'${folderName}\'؟ سيتم حذف جميع الملفات والمجلدات الفرعية أيضاً.";

  static String m5(fileName) =>
      "هل أنت متأكد من الحذف النهائي للملف \'${fileName}\'؟ لا يمكن التراجع عن هذا الإجراء.";

  static String m6(folderName) =>
      "هل أنت متأكد من الحذف النهائي للمجلد \'${folderName}\'؟ لا يمكن التراجع عن هذا الإجراء. سيتم حذف جميع الملفات والمجلدات الفرعية نهائياً.";

  static String m7(folderName) =>
      "هل أنت متأكد من الحذف النهائي للمجلد \'${folderName}\'؟ لا يمكن التراجع عن هذا الإجراء. سيتم حذف جميع الملفات والمجلدات الفرعية نهائياً.";

  static String m8(folderName) =>
      "هل أنت متأكد من إزالة المجلد \'${folderName}\' من الغرفة؟";
  ...
  static String m33(error) => "خطأ في تحميل محتويات المجلد: ${error}";

  static String m34(error) => "خطأ في تحميل الصورة: ${error}";

  static String m35(error) => "خطأ في تحميل ملف النص: ${error}";

  static String m36(error) => "خطأ في تحميل الفيديو: ${error}";

  static String m37(error) => "حدث خطأ";

  static String m38(error) => "خطأ في فتح الملف: ${error}";

  static String m39(error) => "❌ حدث خطأ أثناء الحذف النهائي للمجلد: ${error}";

  static String m40(errorMessage) => "❌ خطأ: ${errorMessage}";

  static String m41(error) => "❌ حدث خطأ أثناء استعادة المجلد: ${error}";

  static String m42(error) => "❌ خطأ في رفع الملفات: ${error}";

  static String m43(error) => "❌ خطأ في رفع المجلد: ${error}";

  static String m44(error) => "❌ خطأ في رفع صورة الملف الشخصي: ${error}";

  static String m45(error) => "خطأ في التحقق من الصورة: ${error}";

  static String m46(error) => "خطأ في التحقق من الفيديو: ${error}";

  static String m47(hours) => "ينتهي خلال ${hours} ساعة";

  static String m48(statusCode) => "فشل تحميل الملف الصوتي (${statusCode})";

  static String m49(error) => "فشل تحميل الملف: ${error}";

  static String m50(error) => "فشل تحميل الصورة: ${error}";

  static String m51(error) => "فشل تحميل ملف PDF: ${error}";

  static String m52(error) => "فشل تحميل PDF للعرض: ${error}";

  static String m53(statusCode) => "فشل تحميل الفيديو (${statusCode})";

  static String m54(error) => "فشل فتح الملف";

  static String m55(message) => "فشل في تحديث حالة المفضلة: ${message}";

  static String m56(fileName) => "✅ تم حذف الملف \'${fileName}\' بنجاح";

  static String m57(fileName) => "✅ تم تحميل الملف بنجاح: ${fileName}";

  static String m58(id) => "معرف الملف: ${id}";

  static String m59(error) => "الملف غير متاح (خطأ ${error})";

  static String m60(path) => "الملف غير موجود: ${path}";

  static String m61(errorMessage) => "تم الحفظ محلياً فقط ,${errorMessage}";

  static String m62(code) => "الملف غير متاح (خطأ ${code})";

  static String m63(code) => "الملف غير متوفر (كود الخطأ: ${code})";

  static String m64(count) => "الملفات (${count})";

  static String m65(error) => "خطأ في التحقق بالبصمة: ${error}";

  static String m66(error) => "❌ فشل إنشاء المجلد: ${error}";

  static String m67(folderName) => "📁 تم إنشاء المجلد \"${folderName}\" بنجاح";

  static String m68(folderName) => "تم إنشاء المجلد بنجاح: ${folderName}";

  static String m69(folderName) => "✅ تم حذف المجلد \'${folderName}\' بنجاح";

  static String m70(fileName) => "✅ تم تحميل المجلد بنجاح: ${fileName}";

  static String m71(folderName) => "المجلد \"${folderName}\" محمي";

  static String m72(folderName) => "المجلد: ${folderName}";
  ...
  static String m75(count) => "المجلدات (${count})";

  static String m76(size) => "حجم الخط: ${size}";

  static String m77(height) => "الارتفاع: ${height}";
  ...
  static String m80(path) => "الملف المحلي غير موجود: ${path}";
  ...
  static String m83(title) => "نقل الملف: ${title}";

  static String m84(fileName) => "نقل الملف: ${fileName}";

  static String m85(folderName) => "نقل المجلد: ${folderName}";

  static String m86(fileName) => "تم مشاركة ملف جديد: ${fileName}";

  static String m87(folderName) => "تم مشاركة مجلد جديد: ${folderName}";

  static String m88(fileName) => "فتح الملف كنص: ${fileName}";

  static String m89(error) => "خطأ في فتح الملف: ${error}";

  static String m90(pageNumber) => "الصفحة: ${pageNumber}";

  static String m91(current, total) => "صفحة ${current} من ${total}";

  static String m92(page, error) =>
      "الملف PDF قد يكون تالفاً أو مشفراً. الصفحة ${page}: ${error}";

  static String m93(statusCode) => "فشل تحميل ملف PDF (${statusCode})";

  static String m94(seconds) =>
      "الرجاء الانتظار ${seconds} ثانية قبل إعادة الإرسال";

  static String m95(x) => "الموضع X: ${x}";

  static String m96(y) => "الموضع Y: ${y}";

  static String m97(quality) => "تم تغيير الجودة إلى ${quality}";

  static String m98(text) => "النص المعرّف: ${text}";

  static String m99(fileName) =>
      "هل أنت متأكد من إزالة \"${fileName}\" من هذه الغرفة؟";

  static String m100(seconds) => "إعادة الإرسال (${seconds})";

  static String m101(role) => "الدور: ${role}";

  static String m102(folderName) =>
      "✅ تم حفظ المجلد \"${folderName}\" في حسابك بنجاح";

  static String m103(error) => "خطأ في البحث: ${error}";
  ...
  static String m105(folderName) => "اختيار \"${folderName}\"";

  static String m106(folderName) => "اختر المجلد";
  ...
  static String m111(count) => "تمت المشاركة مع (${count})";

  static String m112(message) => "خطأ في التعرف على الصوت: ${message}";

  static String m113(error) => "خطأ في التعرف على الصوت: ${error}";

  static String m114(error) => "خطأ في جلب المجلدات الفرعية: ${error}";

  static String m115(name) => "تم تفعيل الترجمة: ${name}";

  static String m116(duration) => "المدة الكلية: ${duration}";

  static String m117(error) => "حدث خطأ أثناء نقل المجلد: ${error}";

  static String m118(error) => "خطأ في رفع الملف: ${error}";

  static String m119(folderName, count) =>
      "✅ تم رفع المجلد \"${folderName}\" بنجاح! (${count} ملف)";

  static String m120(uploadedCount) => "✅ تم رفع ${uploadedCount} ملف بنجاح";
  ...
  static String m123(url) => "الرابط: ${url}";

  static String m124(used, total) =>
      "تم استخدام ${used} جيجابايت من ${total} جيجابايت";

  static String m125(email) => "تم إرسال رمز التحقق إلى ${email}";

  static String m126(error) => "فشل تحميل الفيديو: ${error}";
  ...
  static String m129(width) => "العرض: ${width}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "account_deleted": MessageLookupByLibrary.simpleMessage("حذف الحساب"),
    "actionLabel": MessageLookupByLibrary.simpleMessage("الإجراء"),
    ...
    "adjustVolume": MessageLookupByLibrary.simpleMessage("تعديل مستوى الصوت"),
    ...
    "bytes": MessageLookupByLibrary.simpleMessage("بايت"),
    "canViewPdfAndSearch": MessageLookupByLibrary.simpleMessage(
      "يمكنك عرض PDF والبحث فيه",
    ),
    ...
    "chooseAction": MessageLookupByLibrary.simpleMessage("اختر إجراء"),
    "chooseFolderTitle": MessageLookupByLibrary.simpleMessage(
      "اختر مجلد لحفظ الملف",
    ),
    ...
    "confirmRemoveFileFromRoom": MessageLookupByLibrary.simpleMessage(
      "هل أنت متأكد من إزالة هذا الملف من الغرفة؟",
    ),
    "confirmRemoveFolderFromRoom": MessageLookupByLibrary.simpleMessage(
      "هل أنت متأكد من إزالة هذا المجلد من الغرفة؟",
    ),
    ...
    "controlSubtitlesSettings": MessageLookupByLibrary.simpleMessage(
      "يمكنك التحكم في إعدادات الترجمة من هنا.",
    ),
    "convertFormat": MessageLookupByLibrary.simpleMessage("تحويل الصيغة"),
    ...
    "detailFilesCount": MessageLookupByLibrary.simpleMessage("عدد الملفات"),
    "detailFolder": MessageLookupByLibrary.simpleMessage("مجلد"),
    "detailSharedWith": MessageLookupByLibrary.simpleMessage("تمت المشاركة مع"),
    "detailSize": MessageLookupByLibrary.simpleMessage("الحجم"),
    "detailSubfoldersCount": MessageLookupByLibrary.simpleMessage(
      "عدد المجلدات الفرعية",
    ),
    "detailTags": MessageLookupByLibrary.simpleMessage("الوسوم"),
    "detailTotalSize": MessageLookupByLibrary.simpleMessage("الحجم الإجمالي"),
    "detailType": MessageLookupByLibrary.simpleMessage("النوع"),
    "detailUpdatedAt": MessageLookupByLibrary.simpleMessage("آخر تعديل"),
    "detailsTitle": MessageLookupByLibrary.simpleMessage("التفاصيل"),
    ...
    "editFileMetadata": MessageLookupByLibrary.simpleMessage("تعديل الملف"),
    ...
    "email_changed": MessageLookupByLibrary.simpleMessage(
    ...
    "emptyTrashTitle": MessageLookupByLibrary.simpleMessage(
      "إفراغ سلة المحذوفات",
    ),
    ...
    "entityFile": MessageLookupByLibrary.simpleMessage("ملف"),
    "entityFolder": MessageLookupByLibrary.simpleMessage("مجلد"),
    "entityRoom": MessageLookupByLibrary.simpleMessage("غرفة"),
    ...
    "file_accessed_onetime": MessageLookupByLibrary.simpleMessage(
      "وصول لملف لمرة واحدة",
    ),
    "file_deleted": MessageLookupByLibrary.simpleMessage("حذف ملف"),
    "file_downloaded": MessageLookupByLibrary.simpleMessage("تحميل ملف"),
    "file_moved": MessageLookupByLibrary.simpleMessage("نقل ملف"),
    "file_permanently_deleted": MessageLookupByLibrary.simpleMessage(
      "حذف ملف نهائياً",
    ),
    "file_restored": MessageLookupByLibrary.simpleMessage("استعادة ملف"),
    "file_shared": MessageLookupByLibrary.simpleMessage("مشاركة ملف"),
    "file_starred": MessageLookupByLibrary.simpleMessage("إضافة ملف للمفضلة"),
    "file_unshared": MessageLookupByLibrary.simpleMessage("إلغاء مشاركة ملف"),
    "file_unstarred": MessageLookupByLibrary.simpleMessage(
      "إزالة ملف من المفضلة",
    ),
    "file_updated": MessageLookupByLibrary.simpleMessage("تحديث ملف"),
    "file_uploaded": MessageLookupByLibrary.simpleMessage("رفع ملف"),
    "file_viewed_by_all_members": MessageLookupByLibrary.simpleMessage(
      "عرض ملف من قبل جميع الأعضاء",
    ),
    ...
    "folderAlreadyShared": MessageLookupByLibrary.simpleMessage(
      "ℹ️ المجلد مشارك بالفعل مع هذه الغرفة",
    ),
    ...
    "folderUploadStart": MessageLookupByLibrary.simpleMessage(
      "📁 اختر الملفات التي تريد إضافتها للمجلد...",
    ),
    "folderWithoutName": MessageLookupByLibrary.simpleMessage("مجلد بدون اسم"),
    "folder_created": MessageLookupByLibrary.simpleMessage("إنشاء مجلد"),
    "folder_deleted": MessageLookupByLibrary.simpleMessage("حذف مجلد"),
    "folder_moved": MessageLookupByLibrary.simpleMessage("نقل مجلد"),
    "folder_permanently_deleted": MessageLookupByLibrary.simpleMessage(
      "حذف مجلد نهائياً",
    ),
    "folder_restored": MessageLookupByLibrary.simpleMessage("استعادة مجلد"),
    "folder_shared": MessageLookupByLibrary.simpleMessage("مشاركة مجلد"),
    "folder_starred": MessageLookupByLibrary.simpleMessage(
      "إضافة مجلد للمفضلة",
    ),
    "folder_unshared": MessageLookupByLibrary.simpleMessage(
      "إلغاء مشاركة مجلد",
    ),
    "folder_unstarred": MessageLookupByLibrary.simpleMessage(
      "إزالة مجلد من المفضلة",
    ),
    "folder_updated": MessageLookupByLibrary.simpleMessage("تحديث مجلد"),
    ...
    "highlightText": MessageLookupByLibrary.simpleMessage(
      "تظليل النص (Highlight)",
    ),
    ...
    "lastPage": MessageLookupByLibrary.simpleMessage("الصفحة الأخيرة"),
    ...
    "loadingImage": MessageLookupByLibrary.simpleMessage("تحميل الصورة"),
    ...
    "loginFirst": MessageLookupByLibrary.simpleMessage("⚠️ سجل دخول أولاً"),
    ...
    "noFoldersAvailable": MessageLookupByLibrary.simpleMessage(
      "لا توجد مجلدات متاحة. يرجى إنشاء مجلد أولاً.",
    ),
    ...
    "noPermissionToShareInRoom": MessageLookupByLibrary.simpleMessage(
      "⚠️ ليس لديك صلاحية للمشاركة في هذه الغرفة",
    ),
    ...
    "oneTimeSharedFileError": MessageLookupByLibrary.simpleMessage(
      "❌ الملفات المشتركة لمرة واحدة لا يمكن عرض تفاصيلها أو تحميلها أو التعليق عليها أو حفظها",
    ),
    ...
    "onlyRoomOwnerCanShare": MessageLookupByLibrary.simpleMessage(
      "⚠️ فقط مالك الغرفة يمكنه المشاركة",
    ),
    ...
    "savingFile": MessageLookupByLibrary.simpleMessage("جاري حفظ الملف..."),
    "savingFolder": MessageLookupByLibrary.simpleMessage("جاري حفظ المجلد..."),
    "scanningFile": MessageLookupByLibrary.simpleMessage(
      "جاري فحص الملف أمنياً...",
    ),
    "scopeAll": MessageLookupByLibrary.simpleMessage("الكل"),
    ...
    "searchByTagsHint": MessageLookupByLibrary.simpleMessage(
      "ابحث عن طريق Tag (مثال: مشروع، مهم)",
    ),
    "searchError": m103,
    ...
    "storageAvailable": MessageLookupByLibrary.simpleMessage("المتاح"),
    ...
    "storagePermissionRequired": MessageLookupByLibrary.simpleMessage(
      "⚠️ يرجى منح صلاحية التخزين من الإعدادات",
    ),
    "storageUsage": MessageLookupByLibrary.simpleMessage("استهلاك المساحة"),
    ...
    "textEditedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "✅ تم تعديل النص بنجاح. اضغط على \"حفظ التغييرات\" لرفعه على السيرفر",
    ),
    ...
    "textLabel": MessageLookupByLibrary.simpleMessage("النص"),
    ...
    "trimAudio": MessageLookupByLibrary.simpleMessage("قص الصوت"),
    ...
    "unnamedFolder": MessageLookupByLibrary.simpleMessage("مجلد بدون اسم"),
    "unnamedfile": MessageLookupByLibrary.simpleMessage("ملف بدون اسم"),
    ...
    "unsavedChangesMessage": MessageLookupByLibrary.simpleMessage(
      "لديك تغييرات غير محفوظة، هل أنت متأكد من الخروج؟",
    ),
    "unshare": MessageLookupByLibrary.simpleMessage("إلغاء المشاركة"),
    "unshareFailed": MessageLookupByLibrary.simpleMessage("فشل إلغاء المشاركة"),
    ...
    "uploadFilesSubtitle": MessageLookupByLibrary.simpleMessage(
      "اختر ملف واحد أو عدة ملفات",
    ),
    "uploadFolder": MessageLookupByLibrary.simpleMessage("رفع مجلد"),
