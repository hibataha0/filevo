...
class ApiEndpoints {
  ...
  static const String storageInfo = '/files/storage'; // ✅ معلومات المساحة التخزينية للمستخدم
  static const String totalStorageInfo = '/files/storage/total'; // ✅ المساحة الإجمالية المستخدمة في التطبيق
