...
exports.getAllFolders = asyncHandler(async (req, res, next) => {
    ...
    const foldersWithDetails = await Promise.all(
        folders.map(async (folder) => {
            ...
            console.log(`   ✅ After update - size: ${updatedFolderObj.size}, filesCount: ${updatedFolderObj.filesCount}`);
            console.log(`   ✅ Has filesCount key: ${'filesCount' in updatedFolderObj}`);
            console.log(`   ✅ Final object sample:`, JSON.stringify({
